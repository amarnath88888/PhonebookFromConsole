...
public class PhonebookFromConsole {
	
	public static final Logger logger = Logger.getLogger(PhonebookFromConsole.class);
	
	public static void main(String args[])	{
		DOMConfigurator.configure("log4j.xml");
		ContactsInitializer contactsinitializer = new ContactsInitializer();
		
		PhonebookFromConsole phonebook = new PhonebookFromConsole();
